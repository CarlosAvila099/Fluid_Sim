...
class VelocityAnimation(Enum):
    ...
    Type:
        NORMAL: Constant velocity that stays the same through all the animation.
        ROTATE_CW: Rotates the velocity in a clockwise manner.
        ROTATE_CCW: Rotates the velocity in a counter-clockwise manner.
...
class Velocity:
    ...
    def step(self):
        """Modifies the vector of the velocity depending on the animation of the vector.
        """
